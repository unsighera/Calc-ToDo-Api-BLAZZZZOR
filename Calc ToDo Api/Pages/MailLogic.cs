...
namespace Calc_ToDo_Api.Pages
{
    public static class MailSender
    {
        public static string sendedCode {  get; set; }
        ...
        public static void SendCode(string recipient)
        {
            ...
            using (SmtpClient smtpClient = new SmtpClient())
            {
                message.Subject = "Подтверждение кода регистрации Blazor"; // Заголовок
                message.Body = $"<h1>Это код верификации : {code}</h1>"; //Содержание
